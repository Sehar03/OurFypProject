                  ...
                  <View style={{flexDirection: 'row',justifyContent:"space-between"}}>
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        ...
                        const addressForMap = encodeURIComponent(
                          item.restaurantAddress &&
                            item.restaurantAddress.length > 0
                            ? item.restaurantAddress[0].formattedAddress
                            : '',
                        );
                        Linking.openURL(
            ...
            <View style={{justifyContent: 'center', alignItems: 'center'}}>
              <View
                ...
                <View
                  ...
                  <View
                    style={{flexDirection: 'row', flex: 1, marginTop: hp('2')}}>
                    <FontAwesome
                      name="calendar"
                      size={20}
